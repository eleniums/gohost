...
func RegisterTestServiceHandler(ctx context.Context, mux *runtime.ServeMux, conn *grpc.ClientConn) error {
	...
	mux.Handle("GET", pattern_TestService_Send_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		forward_TestService_Send_0(ctx, outboundMarshaler, w, req, resp, mux.GetForwardResponseOptions()...)
	...
	mux.Handle("GET", pattern_TestService_Echo_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		forward_TestService_Echo_0(ctx, outboundMarshaler, w, req, resp, mux.GetForwardResponseOptions()...)
	...
	mux.Handle("GET", pattern_TestService_Large_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		forward_TestService_Large_0(ctx, outboundMarshaler, w, req, resp, mux.GetForwardResponseOptions()...)
